...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /mnt/d/robonot/src/navigation)
  set(navigation_DEVEL_PREFIX /mnt/d/robonot/devel)
  ...
  set(navigation_INSTALL_PREFIX /mnt/d/robonot/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Soft-illusion <softillusion.robotics@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/d/robonot/src/navigation/${idir}'.  ${_report}")
    endif()
